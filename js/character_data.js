...
const ninja = {
    ...
    sprites: {
        ...
        takeHit: {
            name: 'takeHit',
            imageSrc: 'img/metal_ninja/ninja_takehit.png',
            framesTotal: 6,
            attackSprite: false
        },
        blockHit: {
            name: 'blockHit',
            imageSrc: 'img/metal_ninja/ninja_blockhit.png',
            framesTotal: 12,
            attackSprite: false
        },
        death: {
            name: 'death',
            imageSrc: 'img/metal_ninja/ninja_death.png',
            framesTotal: 12,
            attackSprite: false,
            animationDelays: [12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12]
        },
        victory: {
            name: 'victory',
            imageSrc: 'img/metal_ninja/ninja_victory.png',
            framesTotal: 10,
            attackSprite: false,
            animationDelays: [12, 12, 12, 12, 12, 12, 12, 12, 12, 12]
        },
    },
    audio: {
        hit: new Howl({
            src: './audio/ninja_hit.mp3',
            html5: true,
            volume: 0.3
        }),
        blocked: new Howl({
...
const priestess = {
    ...
    sprites: {
        idle: {
            name: 'idle',
            imageSrc: 'img/water_priestess/priestess_idle.png',
            framesTotal: 8,
            attackSprite: false
        },
        moveForward: {
            name: 'moveForward',
            imageSrc: 'img/water_priestess/priestess_run.png',
            framesTotal: 8,
            attackSprite: false
        },
        moveBackward: {
            name: 'moveBackward',
            imageSrc: 'img/water_priestess/priestess_back.png',
            framesTotal: 10,
            attackSprite: false
        },
        jumpUp: {
            name: 'jumpUp',
            imageSrc: 'img/water_priestess/priestess_up.png',
            framesTotal: 3,
            attackSprite: false
        },
        jumpDown: {
            name: 'jumpDown',
            imageSrc: 'img/water_priestess/priestess_down.png',
            framesTotal: 3,
            attackSprite: false
        },
        attack: {
            name: 'attack',
            imageSrc: 'img/water_priestess/priestess_attack.png',
            framesTotal: 7,
            attackSprite: true,
            animationDelays: [50, 50, 100, 50, 50, 50, 50]
        },
        // throw_start: {
        //     name: 'throwStart',
        //     imageSrc: 'img/water_priestess/priestess_throwstart.png',
        //     framesTotal: 4,
        //     attackSprite: true,
        //     animationDelays: [50, 25, 50, 175]
        // },
        // throw: {
        //     name: 'throw',
        //     imageSrc: 'img/water_priestess/priestess_throw.png',
        //     framesTotal: 9,
        //     attackSprite: true,
        //     animationDelays: [850, 50, 50, 50, 50, 12, 12, 12, 12]
        // },
        // special: {
        //     name: 'special',
        //     imageSrc: 'img/water_priestess/priestess_special.png',
        //     framesTotal: 18,
        //     attackSprite: true
        // },
        takeHit: {
            name: 'takeHit',
            imageSrc: 'img/water_priestess/priestess_takehit.png',
            framesTotal: 7,
            attackSprite: false
        },
        blockHit: {
            name: 'blockHit',
            imageSrc: 'img/water_priestess/priestess_blockhit.png',
            framesTotal: 6,
            attackSprite: false
        },
        death: {
            name: 'death',
            imageSrc: 'img/water_priestess/priestess_death.png',
            framesTotal: 16,
            attackSprite: false,
            animationDelays: [12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12]
        },
        victory: {
            name: 'victory',
            imageSrc: 'img/water_priestess/priestess_victory.png',
            framesTotal: 12,
            attackSprite: false,
            animationDelays: [12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12]
